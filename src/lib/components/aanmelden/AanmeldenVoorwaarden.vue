<template>
  <div>
    ...
    <p>Zie <a href="https://www.rijksoverheid.nl/onderwerpen/schoolvakanties/vraag-en-antwoord/schoolvakanties-2021-2022" target="_blank">rijksoverheid: vakanties naar regio</a>.</p>
    <p>Bij aanmelding is een bedrag van € 5,- aan inschrijfgeld verschuldigd.</p>
    <p>Bij aanmelden in de loop van het seizoen wordt de contributie evenredig berekend. Er wordt echter geen contributie terug betaald indien het lidmaatschap voor het einde van het seizoen wordt beëindigd.</p>
    <p>Opzeggen: Voor onze planning van het aantal uren zaalhuur, leiding, indeling van de groepen en nog een aantal andere zaken is het noodzakelijk dat wij voor aanvang van het verenigingsjaar weten hoeveel leden wij het komende seizoen zullen hebben.</p>
